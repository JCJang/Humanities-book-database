...
const authorPanelPosition = () =>{
  ...
  return (
    <div className={l?"Row":"Column"} style={{paddingTop:l && "3.5rem",color:"var(--paper)",backgroundColor:"var(--ink)",height:openedAuthorHeight(),overflow:"hidden",position:"relative"}}>
